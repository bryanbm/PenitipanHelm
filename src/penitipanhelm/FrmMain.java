...
public class FrmMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        rekap.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Atas Nama", "Barang", "Harga", "Tgl Masuk", "Tgl Ambil"
            }
        ));
        ...
        pnl3.add(jLabel14);
        jLabel14.setBounds(40, 240, 110, 30);

        edit_nama.setEditable(false);
        pnl3.add(edit_nama);
        edit_nama.setBounds(150, 240, 350, 30);
        ...
        jScrollPane2.setBounds(30, 90, 470, 140);

        jLabel15.setForeground(new java.awt.Color(0, 0, 0));
        jLabel15.setText("Total Harga");
        pnl3.add(jLabel15);
        jLabel15.setBounds(40, 280, 110, 30);

        total_harga.setEditable(false);
        pnl3.add(total_harga);
        total_harga.setBounds(150, 280, 350, 30);

        jLabel16.setForeground(new java.awt.Color(0, 0, 0));
        jLabel16.setText("Tanggal Ambil");
        pnl3.add(jLabel16);
        jLabel16.setBounds(40, 320, 110, 30);

        tgl_ambil.setEditable(false);
        pnl3.add(tgl_ambil);
        tgl_ambil.setBounds(150, 320, 350, 30);
        ...
        pnl3.add(jButton3);
        jButton3.setBounds(370, 360, 120, 32);
    ...
    private void takis(){
       ...
       String SQL = "SELECT id,nama,harga FROM help WHERE tgl_keluar IS NULL";
    ...
    private void takiz(){
        String kolom[] = {"ID","Nama","Barang","Total","Tgl Masuk","Tgl Ambil"};
       DefaultTableModel dtms = new DefaultTableModel(null, kolom);
       String SQL = "select id,nama,barang,harga,tgl_masuk,tgl_keluar from help where tgl_keluar is not null";
       ResultSet rs = DBConn.executeQuery(SQL);
       try{
           while(rs.next()){
               ...
               String duta [] = {id,nama,barang,total,tgl1,tgl2};
               dtms.addRow(duta);
           }   
        }catch(SQLException ex){
            Logger.getLogger(FrmMain.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        // Iki save lur
        String SQL = "INSERT INTO help (id,nama,tgl_masuk,barang,harga,tgl_keluar) "
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        int baris = transaksi.getSelectedRow();
        String id = transaksi.getValueAt(baris, 0).toString();
        String SQL = "UPDATE help SET tgl_keluar='"+tgl_ambil.getText()+"' WHERE id="+id;
        int status = DBConn.execute(SQL);
        if (status == 1) {
